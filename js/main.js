...
/*---------------------------
    testimoial slider
------------------------------ */
function testimoialSlider(){
    const crouselOne = document.getElementById('carouselOne');
    if(crouselOne) {
        crouselOne.addEventListener('slid.bs.carousel', function () {
...
function coursePreviewVideo () {
    ...
    if(coursePreviewModal){
        coursePreviewModal.addEventListener("shown.bs.modal", function(){
            ...
            this.querySelector(".js-course-preview-video").currentItem = 0;
        });
...
function styleSwitcherToggle(){
    ...
    const styleSwitcherToggle = document.querySelector(".js-style-switcher-toggle");

    styleSwitcherToggle.addEventListener("click", ()=>{
        styleSwitcher.classList.toggle("open");
        styleSwitcherToggle.querySelector("i").classList.toggle("fa-times");
        styleSwitcherToggle.querySelector("i").classList.toggle("fa-cog");
    });
}
styleSwitcherToggle();
...
function themeGlassEffect(){
    ...
    glassEffectCheckbox.addEventListener("click", ()=>{
